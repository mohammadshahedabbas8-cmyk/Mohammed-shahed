...
export const WandIcon = ({ className }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M15 4V2m0 14v-2m-7.5-10.5L6 4m9 9l1.5 1.5M19 9h2m-14 0H3m14 7.5l1.5 1.5M6.5 6.5L5 5m0 14l1.5-1.5M12 20v2"></path>
...
export const SparklesIcon = ({ className = "w-6 h-6" }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="m12 3-1.9 4.8-4.8 1.9 4.8 1.9L12 16l1.9-4.8 4.8-1.9-4.8-1.9L12 3zM21 12l-1.9 4.8-4.8 1.9 4.8 1.9L21 21l1.9-4.8 4.8-1.9-4.8-1.9L21 12zM3 12l-1.9 4.8-4.8 1.9 4.8 1.9L3 21l1.9-4.8 4.8-1.9-4.8-1.9L3 12z"></path>
  </svg>
);
